...
import { editarTiposPropiedad } from "@/adapters/catalogos";

export default function FormularioPutTipoPropiedad() {
    ...
    useEffect(() => {
        ...
        async function cargarCatalogos() {
            ...
            try {
                ...
                setTiposPropiedad(await editarTiposPropiedad());
    ...
    async function manejarSubmit(e) {
        ...
        if (!formulario.id_tipo_propiedad) {
            ...
            setError(
                "Ingresá el ID del tipo de propiedad."
            );
        ...
        try {
            ...
            const respuesta = await editarTiposPropiedad(
            ...
            console.log(
                "Tipo de propiedad editada:",
                respuesta
            );


            setMensaje(
                "Tipo de propiedad editada correctamente."
            );
            ...
            if (error.status === 401) {
                ...
                setError(
                    "No tenés permisos para editar tipos de propiedad."
                );

            } else if (error.status === 404) {

                setError(
                    "El tipo de priopiedad no existe."
                );

            } else {

                setError(
                    "No se pudo editar el tipo de propiedad."
                );
