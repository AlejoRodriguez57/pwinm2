...
export default function FormularioPutEstado() {
    ...
    async function manejarSubmit(e) {
        ...
        try {
            ...
            const respuesta = await editarEstados(
            ...
            if (error.status === 401) {
                ...
                setError(
                    "No tenés permisos para editar estados."
                );
