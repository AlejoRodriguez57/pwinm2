...
import { crearUbicaciones } from "@/adapters/catalogos";


export default function FormularioPostUbicacion() {
    ...
    async function manejarSubmit(e) {
        ...
        if (!nombre.trim()) {
            ...
            setError(
                "Ingresá un nombre para la ubicación."
            );
        ...
        try {
            ...
            if (error.status === 401) {
                ...
                setError(
                    "No tenés permisos para añadir ubicaciones."
                );
